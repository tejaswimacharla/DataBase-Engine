...
public class Page {
    ...
    public static int makeInteriorPage(RandomAccessFile file) {
        int num_pages = 0;
        try {
            num_pages = (int)(file.length() / (Long.valueOf(pageSize)));
    ...
    public static int[] getKeyArray(RandomAccessFile file, int page) {
        int num = Integer.valueOf(getCellNumber(file, page));
    ...
    public static long getPointerLoc(RandomAccessFile file, int page, int parent) {
        long val = 0;
        try {
            int numCells = Integer.valueOf(getCellNumber(file, parent));
            ...
            for (int i = 1; i < vals.length; i++) {
                switch (stc[i - 1]) {
                    ...
                    case 0x03:
                        ...
                        break;
                    case 0x04:
                        file.writeByte(Byte.valueOf(vals[i]));
                        break;
                    case 0x05:
                        file.writeShort(Short.valueOf(vals[i]));
                        break;
                    case 0x06:
                        file.writeInt(Integer.valueOf(vals[i]));
                        break;
                    case 0x07:
                        file.writeLong(Long.valueOf(vals[i]));
                        break;
                    case 0x08:
                        file.writeFloat(Float.valueOf(vals[i]));
                        break;
                    case 0x09:
                        file.writeDouble(Double.valueOf(vals[i]));
                        break;
                    case 0x0A:
                        s = vals[i];
